...
int sc_main(int argc, char* argv[]) {
	...
	sc_int<8> rx_data = 106; // sc_int type of length 8 (or an 8-bit integer)
	sc_int<4> tx_buf = -5;   // sc_int type of length 4 (or a 4-bit integer, most likely signed)
	...
	cout<< " Binary sign magnitude : rx_data = " << rx_data.to_string(SC_BIN_SM)  << endl; // Binary sign magnitude representation
